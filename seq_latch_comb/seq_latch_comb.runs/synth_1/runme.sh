...
HD_PWD='/home/harmon/Documents/grepos/xilinx_learning/seq_latch_comb/seq_latch_comb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_latch_comb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seq_latch_comb.tcl
