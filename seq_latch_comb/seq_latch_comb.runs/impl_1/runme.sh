...
HD_PWD='/home/harmon/Documents/grepos/xilinx_learning/seq_latch_comb/seq_latch_comb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_latch_comb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seq_latch_comb.tcl -notrace
